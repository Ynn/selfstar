...
Then select your bundle in the list and click *ok* (note that you can also choose to start it automatically). Finally, click on "Install or Update". When done, you can check that the bundle is correctly installed by refreshing the bundle list (or loading the page) :
