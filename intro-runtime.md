...
Then select your bundle in the appropriate directory and click on "Install or Update" (note that you can click a check box to start it after installation). When done, you can check that the bundle is correctly installed by refreshing the bundle list (or loading the page) :
