...
Then select your bundle in the appropriate directory (note that you check a box to start it after installation). Finally, click on "Install or Update". When done, you can check that the bundle is correctly installed by refreshing the bundle list (or loading the page) :
